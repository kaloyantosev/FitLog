...
export const WARMUP_EXERCISES_DATABASE: WarmupExercise[] = [
  ...
  },
  {
    ...
    nameBg: 'Разтваряне с ластик и ротации за раменен пояс',
    ...
    videoUrl: 'https://www.youtube.com/embed/SuvO4TBwSu4',
  },
  {
    id: 'wu-3',
    name: 'Thoracic Cat-Cow & Thread the Needle',
    nameBg: 'Котешки гръб и торакална мобилизация',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/i_0zLUcE-zk',
  },
];
