...
export const MASTER_RECIPES: MealRecipeMaster[] = [
  // --- BREAKFASTS ---
  {
    ...
    description: 'Бавноусвоими комплексни въглехидрати с висок чист протеин от автентичен скир.',
    prepTimeMinutes: 5,
    baseCalories: 510,
    baseProtein: 38,
    baseCarbs: 65,
  ...
  },
  {
    ...
    description: 'Пухкави бъркани селски яйца с натрошено бяло сирене и авокадо върху пълнозърнест хляб.',
    prepTimeMinutes: 10,
    baseCalories: 540,
    baseProtein: 36,
    baseCarbs: 35,
  ...
  },
  {
    ...
    description: 'Пухкави и богати на протеин палачинки с пресен банан и канела.',
    prepTimeMinutes: 12,
    baseCalories: 530,
    baseProtein: 42,
    baseCarbs: 62,
  ...
  },
  {
    ...
    description: 'Традиционна баница по здравословна рецепта с над 35 г протеин и ниско съдържание на мазнини.',
    prepTimeMinutes: 15,
    baseCalories: 480,
    baseProtein: 37,
    baseCarbs: 42,
  ...
  // --- MAIN MEALS (LUNCH & DINNER) ---
  {
    ...
    description: 'Златен фитнес стандарт: крехко пилешко филе с ароматен ориз Басмати и задушени броколи.',
    prepTimeMinutes: 20,
    baseCalories: 620,
    baseProtein: 52,
    baseCarbs: 65,
  ...
  {
    id: 'main-fish-fillet-potatoes-salad',
    name: 'Baked White Fish Fillet with Boiled Potatoes & Fresh Salad',
    nameBg: 'Печена риба (хек / скумрия) с варени картофи и свежа салата',
    category: 'MAIN',
    dietTags: ['BALANCED', 'MEDITERRANEAN', 'PESCATARIAN', 'HIGH_PROTEIN_LOW_CARB'],
    containsIngredients: ['fish', 'potatoes', 'cucumbers', 'olive_oil'],
    photoUrl: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=800&auto=format&fit=crop&q=80',
    description: 'Лесно и достъпно рибно ястие с чист протеин, варени картофи и свежа салата.',
    prepTimeMinutes: 20,
    baseCalories: 560,
    baseProtein: 44,
    baseCarbs: 48,
    baseFats: 14,
    ingredients: [
      { name: 'Fish Fillet (Hake / Mackerel)', nameBg: 'Рибно филе (хек или скумрия)', amountGrams: 200, unit: 'g', calories: 240, protein: 38, carbs: 0, fats: 8.5, category: 'MEAT_FISH' },
      { name: 'Boiled Potatoes with Salt', nameBg: 'Варени картофи', amountGrams: 240, unit: 'g', calories: 208, protein: 4.8, carbs: 48, fats: 0.2, category: 'GRAINS_PANTRY' },
      { name: 'Fresh Salad (Cucumbers & Tomatoes)', nameBg: 'Салата краставици и домати', amountGrams: 150, unit: 'g', calories: 28, protein: 1.2, carbs: 5.5, fats: 0.3, category: 'PRODUCE' },
      { name: 'Olive Oil & Lemon', nameBg: 'Зехтин и лимон', amountGrams: 10, unit: 'g', calories: 84, protein: 0, carbs: 0, fats: 9.5, category: 'FATS_NUTS' },
    ],
  },
  {
    id: 'main-beef-mince-potatoes-shopska',
    name: 'Pan-Seared Minced Beef / Meatballs with Baked Potatoes & Salad',
    nameBg: 'Телешка кайма на тиган с печени картофи и шопска салата',
    category: 'MAIN',
    ...
    description: 'Лесна за приготвяне и достъпна телешка кайма на тиган с печени картофи и свежа шопска салата.',
    prepTimeMinutes: 18,
    baseCalories: 640,
    baseProtein: 48,
    baseCarbs: 52,
    baseFats: 20,
    ingredients: [
      { name: 'Lean Minced Beef / Patties', nameBg: 'Чиста телешка кайма на тиган', amountGrams: 200, unit: 'g', calories: 270, protein: 42, carbs: 0, fats: 11, category: 'MEAT_FISH' },
      { name: 'Roasted Potatoes', nameBg: 'Печени картофи', amountGrams: 240, unit: 'g', calories: 208, protein: 4.8, carbs: 48, fats: 0.2, category: 'GRAINS_PANTRY' },
  ...
  },
  {
    ...
    description: 'Традиционни домашни кюфтета на скара с кафяв ориз и автентична лютеница.',
    prepTimeMinutes: 20,
    baseCalories: 650,
    baseProtein: 48,
    baseCarbs: 58,
  ...
  },
  {
    ...
    photoUrl: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=800&auto=format&fit=crop&q=80',
    description: 'Прясна пъстърва на скара с морска сол, лимон, пресен копър и задушени картофи.',
    prepTimeMinutes: 20,
    baseCalories: 580,
    baseProtein: 48,
    baseCarbs: 46,
  ...
  {
    id: 'main-chicken-rice-veggies',
    name: 'Pan-Seared Chicken Breast with White Rice & Steamed Vegetables',
    nameBg: 'Пилешко филе на тиган с бял ориз и задушени зеленчуци',
    category: 'MAIN',
    dietTags: ['BALANCED', 'BODYBUILDING_PREP', 'MEDITERRANEAN'],
    containsIngredients: ['chicken', 'white_rice', 'peppers', 'zucchini', 'olive_oil'],
    photoUrl: 'https://images.unsplash.com/photo-1543339308-43e59d6b73a6?w=800&auto=format&fit=crop&q=80',
    description: 'Бързо, лесно и евтино фитнес ястие с крехко пилешко филе, ориз и пресни задушени зеленчуци.',
    prepTimeMinutes: 18,
    baseCalories: 580,
    baseProtein: 50,
    baseCarbs: 58,
    baseFats: 12,
    ingredients: [
      { name: 'Chicken Breast Fillet', nameBg: 'Пилешко филе гърди', amountGrams: 210, unit: 'g', calories: 252, protein: 50.4, carbs: 0, fats: 3.5, category: 'MEAT_FISH' },
      { name: 'White Rice Cooked', nameBg: 'Бял ориз сварен', amountGrams: 200, unit: 'g', calories: 260, protein: 5.4, carbs: 56, fats: 0.6, category: 'GRAINS_PANTRY' },
      { name: 'Steamed Mixed Vegetables', nameBg: 'Задушени тиквички и чушки', amountGrams: 150, unit: 'g', calories: 45, protein: 2.2, carbs: 9.0, fats: 0.4, category: 'PRODUCE' },
      { name: 'Olive Oil', nameBg: 'Зехтин', amountGrams: 6, unit: 'g', calories: 53, protein: 0, carbs: 0, fats: 6, category: 'FATS_NUTS' },
    ],
  },
  {
    id: 'main-pork-steak-potatoes-salad',
    name: 'Pork Steak with Baked Potatoes & Cabbage Salad',
    nameBg: 'Свинска пържола от бут с печени картофи и зелева салата',
    category: 'MAIN',
    dietTags: ['BALANCED', 'MEDITERRANEAN', 'HIGH_PROTEIN_LOW_CARB'],
    containsIngredients: ['pork', 'potatoes', 'olive_oil'],
    photoUrl: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=800&auto=format&fit=crop&q=80',
    description: 'Сочна свинска пържола от чисто месо с обикновени печени картофи на фурна и зелева салата.',
    prepTimeMinutes: 20,
    baseCalories: 600,
    baseProtein: 48,
    baseCarbs: 50,
    baseFats: 16,
    ingredients: [
      { name: 'Lean Pork Steak (But/Kotlet)', nameBg: 'Свинска пържола от бут/котлет', amountGrams: 200, unit: 'g', calories: 270, protein: 44, carbs: 0, fats: 9.5, category: 'MEAT_FISH' },
      { name: 'Baked Potatoes with Herbs', nameBg: 'Печени картофи на фурна', amountGrams: 240, unit: 'g', calories: 208, protein: 4.8, carbs: 48, fats: 0.2, category: 'GRAINS_PANTRY' },
      { name: 'Shredded Cabbage & Carrot Salad', nameBg: 'Зелева салата с моркови', amountGrams: 120, unit: 'g', calories: 38, protein: 1.5, carbs: 7.2, fats: 0.2, category: 'PRODUCE' },
      { name: 'Olive Oil Drizzle', nameBg: 'Зехтин', amountGrams: 8, unit: 'g', calories: 70, protein: 0, carbs: 0, fats: 8, category: 'FATS_NUTS' },
    ],
  },
  {
    id: 'main-beef-bolognese-pasta',
    name: 'Classic Lean Beef Bolognese Pasta with Parmesan',
    nameBg: 'Класическа Паста Болонезе с телешка кайма и пармезан',
    category: 'MAIN',
    dietTags: ['BALANCED', 'MEDITERRANEAN'],
    containsIngredients: ['beef', 'pasta', 'tomatoes', 'cheese'],
    photoUrl: 'https://images.unsplash.com/photo-1621996346565-e3d5d6281699?w=800&auto=format&fit=crop&q=80',
    description: 'Класическа и лесна паста с чисто телешко месо в доматен сос и настърган пармезан.',
    prepTimeMinutes: 20,
    baseCalories: 590,
    baseProtein: 48,
    baseCarbs: 64,
    baseFats: 14,
    ingredients: [
      { name: 'Lean Minced Beef (90% lean)', nameBg: 'Чиста телешка кайма', amountGrams: 170, unit: 'g', calories: 240, protein: 35.0, carbs: 0, fats: 11.0, category: 'MEAT_FISH' },
      { name: 'Durum Wheat Pasta (Cooked)', nameBg: 'Паста / спагети (сварени)', amountGrams: 200, unit: 'g', calories: 260, protein: 9.0, carbs: 52.0, fats: 1.2, category: 'GRAINS_PANTRY' },
      { name: 'Tomato Sauce / Passata', nameBg: 'Доматен сос / пасата', amountGrams: 120, unit: 'g', calories: 42, protein: 1.8, carbs: 8.4, fats: 0.2, category: 'PRODUCE' },
      { name: 'Grated Parmesan Cheese', nameBg: 'Настърган пармезан', amountGrams: 12, unit: 'g', calories: 48, protein: 4.2, carbs: 0.5, fats: 3.4, category: 'DAIRY_EGGS' },
    ],
  },
  {
    ...
    description: 'Богата на растителен протеин кафява леща със запечено сирене и печени чушки.',
    prepTimeMinutes: 18,
    baseCalories: 600,
    baseProtein: 42,
    baseCarbs: 58,
  ...
  },
  {
    ...
    description: 'Пълнозърнеста паста с риба тон, сладка царевица и лек протеинов дресинг от кисело мляко.',
    prepTimeMinutes: 12,
    baseCalories: 610,
    baseProtein: 48,
    baseCarbs: 68,
  ...
  // --- SNACKS & PRE/POST WORKOUT FUEL ---
  {
    ...
    description: 'Гъст пробиотичен скир, обогатен с полезни мазнини и минерали от бадеми.',
    prepTimeMinutes: 3,
    baseCalories: 280,
    baseProtein: 24,
    baseCarbs: 18,
  ...
  },
  {
    ...
    photoUrl: 'https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?w=800&auto=format&fit=crop&q=80',
    description: 'Идеално предтренировъчно зареждане с чиста енергия и стабилна кръвна захар.',
    prepTimeMinutes: 3,
    baseCalories: 290,
    baseProtein: 10,
    baseCarbs: 38,
  ...
  },
  {
    ...
    description: 'Бързоусвоим чист суроватъчен протеин в комбинация със свежа хрупкава ябълка.',
    prepTimeMinutes: 2,
    baseCalories: 230,
    baseProtein: 27,
    baseCarbs: 24,
  ...
  },
  {
    ...
    description: 'Бавноусвоим протеин от нискомаслена извара с орехи за продължително възстановяване и ситост.',
    prepTimeMinutes: 4,
    baseCalories: 260,
    baseProtein: 26,
    baseCarbs: 16,
